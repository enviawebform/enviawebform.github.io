<div>
   ...
   <form class="form-horizontal" data-container="true" style="null">
         <style>
...
<script>
    function ReloadLookup(id) {
        MsCrmMkt.MsCrmFormLoader.fillLookupFromSearch(id)
            .then(function (r) {
    ...
    function Reload() {
        ReloadLookup('e8eb2038-89bc-ed11-83ff-0022489fdd37'); //Reload Line or Mode
        ReloadLookup('d5e70658-89bc-ed11-83ff-0022489fdd37'); //Reload Direction
        ReloadLookup('51f635b9-00fb-ed11-8849-00224899e947');//Reload Ville
        ReloadLookup('cc306da8-89bc-ed11-83ff-0022489fdd37'); //Reload Stop
    }
    MsCrmMkt.MsCrmFormLoader.on("afterFormLoad", function () {
        $('label.error').text('ce champs est obligatoire.');
        const Course = document.getElementById('a163ceb8-7ccc-ed11-b597-002248a2300e');
        console.log(Course);
        var observer = new MutationObserver(function (mutations) {
            console.log('data-value changed');
            if (mutations[0].target.dataset.value == "tdv_objetdumessages,djFe+i98P1DmhyiRkyd+eDv7jtd+Ah9LlvkDEJ17bEsv5Q==") {
                $('#be32e78a-bbc1-ed11-83ff-002248a2300e').attr('value', 'ASTUCE');
                $('#be32e78a-bbc1-ed11-83ff-002248a2300e').attr('data-value', 'team,djEjKoVeXkvJ9lXh+dvytCrl38uCgr4L1Qa2cx2EVOc0wg==');
                $(".AmendeRec").show();
                $(".objetPer").hide();
                $(".AutreRecl").hide();
                $(".Autredemande").hide();
            ...
            else if (mutations[0].target.dataset.value == "tdv_objetdumessages,djEzHM5NDxfqWWhE5Yw8DjgfikXrNGsE/PQbI5rMK4e5sg==") {

                $('#be32e78a-bbc1-ed11-83ff-002248a2300e').attr('data-value', 'team,djEOQzgjfYKTXIGmK5rHc3QzHVp0lb8j8xIyZC9dvgi7PA==');
                $('#be32e78a-bbc1-ed11-83ff-002248a2300e').attr('value', 'Lovelo');
                $(".AmendeRec").hide();
                $(".Abonnements").hide();
                $(".Autredemande").hide();
                $(".objetPer").hide();
    ...
    var fileInput = document.getElementById('fileNote');
    var fileList = [];
    var fileBase64 = [];
    var jsondata = "";
    var toBase64 = "";
    fileInput.addEventListener('change', async function (evnt) {
        ...
        for (var i = 0; i < fileInput.files.length; i++) {
            ...
            fileBase64.push(await toBase64(fileList[i]));
            var iSize = fileInput.files[i].size;
            if (iSize > 5 * 1024 * 1024) {
                $("#error1").text("La taille du fichier dépasse 5 Mo.");
                fileInput.value = '';
                //  $(fileInput).attr("required", "required");
                //  $(fileInput).attr("aria-required", "true");
                //  $(fileInput).attr("data-requirederrormessage", "La taille du fichier dépasse 5 Mo");
                return;
            }
            else {
                $("#error1").text("");
            ...
            var ext = fileInput.files[i].name.split('.');
            switch (ext[1]) {
                ...
                case 'vst': case 'vsw': case 'ws': case 'wsc': case 'wsf': case 'wsh': case 'svg':
                    ...
                    $("#error1").text("L'extension de fichier n'est pas autorisée.");
                    fileInput.value = '';
                    return;
                    break;
                default:
            ...
            jsondata = jsondata + '{ "FileName":"' + fileList[i].name + '" , "FileSize":"' + fileList[i].size + '" , "FileType":"' + fileList[i].type + '" , "FileData":"' + fileBase64[i] + '"   }'
            if (i < fileInput.files.length && i != fileInput.files.length - 1)
                jsondata = jsondata + ",";
        }
        jsondata = jsondata + ']}';
    }
    ...
    MsCrmMkt.MsCrmFormLoader.on('formSubmit', function (event) {
        const ville = $('#8de0dfad-25cc-ed11-b597-00224899e947');
        const codep = $('#eae4766c-f91a-4648-afb1-259b97e89cab');

        const emailT = $('#7f685ebb-7c54-4cff-a1bc-772562d25c38');
        const objet = $('#a163ceb8-7ccc-ed11-b597-002248a2300e');
        const dateetheure = $('#30990092-88bc-ed11-83ff-0022489fdd37');
        const votreM = $('#4e6bc426-89bc-ed11-83ff-0022489fdd37');
        const radio = $('#eb8d2c30-f064-ed11-9561-0022489fdafe_100000000');
        ...
        if ($(ville).val() == "") {
            ...
            $(ville).css('border', '1px solid #ccc');
        }
        if ($(codep).val() == "") {

            $(codep).css('border-color', 'red');
        }
        else {
            $(codep).css('border', '1px solid #ccc');
        }
        var emailval = $(emailT).val();
        if ($(emailT).val() == "") {
            $(emailT).css('border-color', 'red');
        }
        else if ($(emailT).val() != "") {
            if (emailval.includes('@', 0) && emailval.includes('.', 0)) {

                $(emailT).css('border', '1px solid #ccc');
            }
            else {
                $(emailT).css('border-color', 'red');
            }
        ...
        if ($(objet).val() == "") {
            ...
            $(objet).css('border', '1px solid #ccc');
        }

        if ($(votreM).val() == "") {
            $(votreM).css('border-color', 'red');
        }
        else {
            $(votreM).css('border', '1px solid #ccc');
        }
        // get the id of the elements through developer tools of the browser
        // based on selected current living situation (optionset)
        if (jsondata != "") {
            document.getElementById('8ca9dd08-81f2-ed11-8849-002248a2300e').value = jsondata;
        }
    });
    function CheckFields(str) {
        const prenom = $('#3f746946-34b4-442c-a677-e232cdd2bc40');
        const nom = $('#e1dfc514-f301-4cb2-855a-4c8fa8331207');
        const codep = $('#eae4766c-f91a-4648-afb1-259b97e89cab');
        const email123 = $('#7f685ebb-7c54-4cff-a1bc-772562d25c38');
        const objet = $('#a163ceb8-7ccc-ed11-b597-002248a2300e');
        const dateetheure = $('#30990092-88bc-ed11-83ff-0022489fdd37');
        const votreM = $('#4e6bc426-89bc-ed11-83ff-0022489fdd37');
        if (str == 'prenom') {
        ...
        var emailval = $(email123).val();

        if (str == 'emailField') {
            if ($(email123).val() == "") {
                $(email123).css('border-color', 'red');
            }
            else if ($(email123).val() != "") {
                if (emailval.includes('@', 0) && emailval.includes('.', 0)) {

                    $(email123).css('border', '1px solid #ccc');
                }
                else {
                    $(email123).css('border-color', 'red');
                }
        ...
        // {
        //     if ($(dateetheure).text() == "") {
        //         $(dateetheure).css('border-color','red');
        //     }  
        //      else
        //     {
        //         $(dateetheure).css('border','1px solid #ccc'); 
        //     }
        // }
        if (str == 'votremessage') {
            if ($(votreM).val() == "") {
 ...
 <div data-editorblocktype="Field-text"></div>
 ...
 <div data-editorblocktype="Field-text"></div>
          ...
          <div class="alert alert-danger summary-form hidden" data-valmsg="Un ou plusieurs champs obligatoires n'ont pas été remplis correctement. Merci de vérifier votre saisie :"
           role="alert" style=""></div>
<div data-editorblocktype="Field-text" style="padding-top: 0px; margin: 0px;"><div class="marketing-field">
<fieldset class="form-group"><label class="col-md-3 control-label cw-asterisk" for="eb8d2c30-f064-ed11-9561-0022489fdafe">Civilité</label>
<ul class="list-inline no-margin-bottom col-md-5">
	<li><label class="radio-inline" for="Mr" style="font-family:roboto,Helvetica,Arial,sans-serif;font-size:14px;">
        <input class="lp-form-fieldinput" required="required" id="eb8d2c30-f064-ed11-9561-0022489fdafe_100000000" name="eb8d2c30-f064-ed11-9561-0022489fdafe" placeholder="" type="radio" data-requirederrormessage="* Merci de vérifier votre civilité" value="100000000" style="margin-top:5px" title="Ce champ est obligatoire.">M. </label></li>
	<li><label class="radio-inline" for="Mme" style="font-family:roboto,Helvetica,Arial,sans-serif;font-size:14px;">
        <input class="lp-form-fieldInput" id="eb8d2c30-f064-ed11-9561-0022489fdafe_100000001" data-requirederrormessage="* Merci de vérifier votre civilité" 
        name="eb8d2c30-f064-ed11-9561-0022489fdafe" placeholder="" type="radio" value="100000001" style="margin-top:-7px"> Mme. </label></li>
...
<div class="form-group required"><label class="col-md-3 control-label cw-asterisk">Prénom</label>
<div class="col-md-5"><input aria-required="true" autofocus="autofocus" class="lp-form-fieldInput" data-requirederrormessage="* Merci de vérifier votre Prénom" 
id="3f746946-34b4-442c-a677-e232cdd2bc40" name="3f746946-34b4-442c-a677-e232cdd2bc40" pattern=".*\S+.*" placeholder="" style="width: 100%; box-sizing: border-box;" 
type="text" required="required" title="Ce champ est obligatoire." onchange="CheckFields('prenom');"></div>
</div>
</div>
...
<div class="col-md-5">
    <input aria-required="true" class="lp-form-fieldInput" id="e1dfc514-f301-4cb2-855a-4c8fa8331207" name="e1dfc514-f301-4cb2-855a-4c8fa8331207" pattern=".*\S+.*" placeholder="" required="required" data-requirederrormessage="* Merci de vérifier votre Nom" style="width: 100%; box-sizing: border-box;" title="Ce champ est obligatoire." type="text" onchange="CheckFields('nom');"></div>
</div>
</div>
...
<div data-editorblocktype="Field-text"><div class="marketing-field">
        ...
        <div class="col-md-5">
            <textarea class="lp-form-fieldInput" cols="20" id="790a6bdd-7832-4dd6-8f30-ed8d8772966e" name="790a6bdd-7832-4dd6-8f30-ed8d8772966e" type="text" rows="2"></textarea>
...
<div class="form-group required"><label class="col-md-3 control-label cw-asterisk" for="8de0dfad-25cc-ed11-b597-00224899e947">Ville<span class="lp-required" style="color: rgb(255, 0, 0);"></span></label>
<div class="col-md-5"><input aria-required="true" class="lp-form-fieldInput" data-requirederrormessage="* Merci de vérifier votre saisie: Ville" id="8de0dfad-25cc-ed11-b597-00224899e947" list="list-8de0dfad-25cc-ed11-b597-00224899e947" name="8de0dfad-25cc-ed11-b597-00224899e947" placeholder="" required="required" style="width: 100%; box-sizing: border-box;border:1px solid #ccc;background-size:1.5em 1.4em;filter:drop-shadow(0 0 0px black);" type="text" title="Ce champ est obligatoire."><datalist id="list-8de0dfad-25cc-ed11-b597-00224899e947"></datalist></div>
</div>
</div>
...
<div data-editorblocktype="Field-text"><div class="marketing-field">
<div class="form-group required"><label class="col-md-3 control-label cw-asterisk" for="eae4766c-f91a-4648-afb1-259b97e89cab">Code postal<span class="lp-required" style="color: rgb(255, 0, 0);"></span></label>
<div class="col-md-5"><input aria-describedby="error-eae4766c-f91a-4648-afb1-259b97e89cab" aria-required="true" autofocus="autofocus" class="lp-form-fieldInput" data-val="true" data-val-required="Champ obligatoire" id="eae4766c-f91a-4648-afb1-259b97e89cab" name="eae4766c-f91a-4648-afb1-259b97e89cab" pattern=".*\S+.*" required="required" title="Ce champ est obligatoire." style="width: 100%; box-sizing: border-box;" type="text" value="" onchange="CheckFields('CodeP');"></div>
</div>
</div>
...
<div class="form-group required"><label class="col-md-3 control-label cw-asterisk" for="7f685ebb-7c54-4cff-a1bc-772562d25c38">E-mail</label>
<div class="col-md-5"><input aria-describedby="error-7f685ebb-7c54-4cff-a1bc-772562d25c38" class="lp-form-fieldInput" data-requirederrormessage="* Merci de vérifier votre saisie: E-mail&quot;" data-val="true" data-val-email="Le format de l'adresse email est incorrect" data-val-required="Champ obligatoire" id="7f685ebb-7c54-4cff-a1bc-772562d25c38" name="7f685ebb-7c54-4cff-a1bc-772562d25c38" 

placeholder="" required="required" style="width: 100%; box-sizing: border-box;" type="email" value="" title="Ce champ est obligatoire." onchange="CheckFields('emailField');"></div>
</div>
</div>
   ...
   <div data-editorblocktype="Field-phone"><div class="marketing-field">
     <div class="form-group required">
        <label class="col-md-3 control-label" for="PhoneMobile">Téléphone</label>
        <div class="col-md-5">
...
<div data-editorblocktype="Field-phone"><div class="marketing-field">
<div class="form-group required"><label class="col-md-3 control-label" for="PhoneNumber">Téléphone Mobile</label>
<div class="col-md-5"><input aria-describedby="error-PhoneNumber" class="lp-form-fieldInput" id="ac6a065d-364e-40d6-9a19-d9bf1ed4aa3e" name="ac6a065d-364e-40d6-9a19-d9bf1ed4aa3e" style="width: 100%; box-sizing: border-box;" type="tel" value=""></div>
</div>
</div>
...
<div data-editorblocktype="Field-lookup"><div class="marketing-field">
<div class="form-group required"><label class="col-md-3 control-label cw-asterisk" for="a163ceb8-7ccc-ed11-b597-002248a2300e">Objet du message</label>
<div class="col-md-5"><input class="lp-form-fieldInput" data-parent-child-entity-logicalname="tdv_objetdumessages" data-parent-child-to-parent="tdv_network" data-parent-fieldid="be32e78a-bbc1-ed11-83ff-002248a2300e" data-requirederrormessage="* Merci de vérifier votre saisie: Objet du message" id="a163ceb8-7ccc-ed11-b597-002248a2300e" list="list-a163ceb8-7ccc-ed11-b597-002248a2300e" name="a163ceb8-7ccc-ed11-b597-002248a2300e" placeholder="" required="required" style="width: 100%; box-sizing: border-box;border:1px solid #ccc;background-size:1.5em 1.4em;filter:drop-shadow(0 0 0px black);" type="text" title="Ce champ est obligatoire." onchange="CheckFields('objet');"><datalist id="list-a163ceb8-7ccc-ed11-b597-002248a2300e"></datalist></div>
</div>
</div>
...
<div data-editorblocktype="Field-datetime"><div class="marketing-field">
          <div class="form-group required">
        <label class="col-md-3 control-label cw-asterisk" for="30990092-88bc-ed11-83ff-0022489fdd37">Date et heure</label>
        <div class="col-md-5">
           <input class="lp-form-fieldInput" id="30990092-88bc-ed11-83ff-0022489fdd37" name="30990092-88bc-ed11-83ff-0022489fdd37" pattern="[0-9]{4}-[0-9]{2}-[0-9]{2}T[0-9]{2}:[0-9]{2}" placeholder="" title="" type="datetime-local" data-requirederrormessage="* Merci de vérifier votre saisie: Date et heure" style="width: 100%; box-sizing: border-box;">
...
<div data-editorblocktype="Field-lookup"><div class="marketing-field">
<div class="form-group required"><label class="col-md-3 control-label cw-asterisk" for="e8eb2038-89bc-ed11-83ff-0022489fdd37">Ligne ou mode de transport</label>
<div class="col-md-5"><input class="lp-form-fieldInput" data-parent-child-entity-logicalname="mso_bulineormode" data-parent-child-to-parent="ownerid" 
data-parent-fieldid="be32e78a-bbc1-ed11-83ff-002248a2300e" data-requirederrormessage="* Merci de vérifier votre saisie: Line or Mode" id="e8eb2038-89bc-ed11-83ff-0022489fdd37" 
list="list-e8eb2038-89bc-ed11-83ff-0022489fdd37" name="e8eb2038-89bc-ed11-83ff-0022489fdd37" placeholder="" style="width: 100%; box-sizing: border-box;border:1px solid #ccc;background-size:1.5em 1.4em;filter:drop-shadow(0 0 0px black);" type="text"> <datalist id="list-e8eb2038-89bc-ed11-83ff-0022489fdd37"></datalist></div>
</div>
</div>
     ...
     <div class="AutreRecl objetPer" style="display: none;">
<div data-editorblocktype="Field-lookup"><div class="marketing-field">
<div class="form-group required"><label class="col-md-3 control-label cw-asterisk" for="d5e70658-89bc-ed11-83ff-0022489fdd37">Direction</label>
<div class="col-md-5"><input class="lp-form-fieldInput" data-parent-child-entity-logicalname="mso_budirection" data-parent-child-to-parent="tdv_lineormode" 
data-parent-fieldid="e8eb2038-89bc-ed11-83ff-0022489fdd37" data-requirederrormessage="* Merci de vérifier votre saisie: Direction" id="d5e70658-89bc-ed11-83ff-0022489fdd37" 
list="list-d5e70658-89bc-ed11-83ff-0022489fdd37" name="d5e70658-89bc-ed11-83ff-0022489fdd37" placeholder="" 
style="width: 100%; box-sizing: border-box;border:1px solid #ccc;background-size:1.5em 1.4em;filter:drop-shadow(0 0 0px black);" type="text">
 <datalist id="list-d5e70658-89bc-ed11-83ff-0022489fdd37"></datalist></div>
</div>
</div>
...
<div data-editorblocktype="Field-lookup"><div class="marketing-field">
<div class="form-group required" data-required-field="true"><label class="col-md-3 control-label cw-asterisk" for="51f635b9-00fb-ed11-8849-00224899e947">Ville</label>
<div class="col-md-5"><input class="lp-form-fieldInput" data-parent-child-entity-logicalname="tdv_networkcitylink" data-parent-child-to-parent="tdv_network" 
data-parent-fieldid="be32e78a-bbc1-ed11-83ff-002248a2300e" id="51f635b9-00fb-ed11-8849-00224899e947" list="list-51f635b9-00fb-ed11-8849-00224899e947" 
name="51f635b9-00fb-ed11-8849-00224899e947" placeholder="" style="width: 100%; box-sizing: border-box;border:1px solid #ccc;background-size:1.5em 1.4em;filter:drop-shadow(0 0 0px black);" 
type="text"><datalist id="list-51f635b9-00fb-ed11-8849-00224899e947"></datalist></div>
</div>
</div>
...
<div data-editorblocktype="Field-lookup"><div class="marketing-field">
<div class="form-group required"><label class="col-md-3 control-label cw-asterisk" for="cc306da8-89bc-ed11-83ff-0022489fdd37">Arret</label>
<div class="col-md-5"><input class="lp-form-fieldInput" data-parent-child-entity-logicalname="mso_bustoporstation" data-parent-child-to-parent="tdv_networkcitylink" data-parent-fieldid="51f635b9-00fb-ed11-8849-00224899e947" data-requirederrormessage="* Merci de vérifier votre saisie: Arret" id="cc306da8-89bc-ed11-83ff-0022489fdd37" list="list-cc306da8-89bc-ed11-83ff-0022489fdd37" name="cc306da8-89bc-ed11-83ff-0022489fdd37" placeholder="" style="width: 100%; box-sizing: border-box;border:1px solid #ccc;background-size:1.5em 1.4em;filter:drop-shadow(0 0 0px black);" type="text"> <datalist id="list-cc306da8-89bc-ed11-83ff-0022489fdd37"></datalist></div>
</div>
</div>
   ...
   <div class="objetPer" style="display: none;">
       <div data-editorblocktype="Field-lookup"><div class="marketing-field">
<div class="form-group required"><label class="col-md-3 control-label cw-asterisk" for="2cbc036f-89bc-ed11-83ff-0022489fdd37">Type d'objet</label>
<div class="col-md-5"><input class="lp-form-fieldInput" data-requirederrormessage="* Merci de vérifier votre saisie: Type d'objet" id="2cbc036f-89bc-ed11-83ff-0022489fdd37" list="list-2cbc036f-89bc-ed11-83ff-0022489fdd37" name="2cbc036f-89bc-ed11-83ff-0022489fdd37" placeholder="" style="width: 100%; box-sizing: border-box;border:1px solid #ccc;background-size:1.5em 1.4em;filter:drop-shadow(0 0 0px black);" type="text"><datalist id="list-2cbc036f-89bc-ed11-83ff-0022489fdd37"></datalist>
</div>
</div>
</div>
</div>
<div data-editorblocktype="Field-text"><div class="marketing-field">
<div class="form-group required"><label class="col-md-3 control-label cw-asterisk" for="18456f87-89bc-ed11-83ff-0022489fdd37">Description de l'objet</label>
<div class="col-md-5">

<input aria-describedby="error-18456f87-89bc-ed11-83ff-0022489fdd37" class="lp-form-fieldInput" id="18456f87-89bc-ed11-83ff-0022489fdd37" name="18456f87-89bc-ed11-83ff-0022489fdd37" style="width: 100%; box-sizing: border-box;" type="text" value="">
 <span class="field-validation-valid text-error" data-valmsg-for="18456f87-89bc-ed11-83ff-0022489fdd37" data-valmsg-replace="true" id="18456f87-89bc-ed11-83ff-0022489fdd37"></span>
</div>
</div>
</div>
...
<div data-editorblocktype="Field-text"><div class="marketing-field">
        ...
        <div class="col-md-5">
            <input aria-describedby="error-eb8d2c30-f064-ed11-9561-0022489fdafe" data-requirederrormessage="* Merci de vérifier votre saisie: N° abonné" class="lp-form-fieldInput" id="68261a31-04cc-ed11-b597-0022489fdd37" name="68261a31-04cc-ed11-b597-0022489fdd37" type="text" value="" style="width: 100%; box-sizing: border-box;">
...
<div data-editorblocktype="Field-text"><div class="marketing-field">
     <div class="form-group required">
 <label class="col-md-3 control-label" for="8be9c050-78c3-ed11-83ff-0022489ce5f0">Référence PV</label>
        <div class="col-md-5">
            <input aria-describedby="error-8be9c050-78c3-ed11-83ff-0022489ce5f0" data-requirederrormessage="* Merci de vérifier votre saisie: N° amende" class="lp-form-fieldInput" id="8be9c050-78c3-ed11-83ff-0022489ce5f0" name="8be9c050-78c3-ed11-83ff-0022489ce5f0" type="text" value="" style="width: 100%; box-sizing: border-box;">
...
<div class="form-group required"><label class="col-md-3 control-label cw-asterisk" for="4e6bc426-89bc-ed11-83ff-0022489fdd37">Votre message</label>
<div class="col-md-5"><textarea aria-describedby="error-eb8d2c30-f064-ed11-9561-0022489fdafe" aria-required="true" class="lp-form-fieldInput" data-requirederrormessage="* Merci de vérifier votre saisie: Votre message" id="4e6bc426-89bc-ed11-83ff-0022489fdd37" maxlength="" name="4e6bc426-89bc-ed11-83ff-0022489fdd37" required="required" rows="20" style="width: 100%;height:100%;min-height:140px; box-sizing: border-box;" type="text" value="" title="Ce champ est obligatoire." onchange="CheckFields('votremessage');"></textarea></div>
</div>
</div>
...
<div data-editorblocktype="Field-file"><div class="marketing-field">
    <div class="form-group required"><label class="col-md-3 control-label">Pièce(s) jointe(s)</label>
        <div class="col-md-5"> <input type="file" data-max-size="5e+6" id="fileNote" class="lp-form-fieldInput" multiple="" data-requirederrormessage="" aria-required="">
       <div class="errorMessage" id="error1" style="color:red;"></div>
    </div>
</div>
</div>
</div>
   
<div data-editorblocktype="SubscriptionListBlock"><div class="marketing-subscription-list">
<div class="form-group">
<div class="checkbox col-md-5 col-md-offset-3"><label><input acceptnewsletter="" class="lp-form-fieldInput" data-val="true" data-val-required="Le champ En cochant cette case j'accepte de recevoir des informations commerciales de la part de {0} est requis." id="3281ed7a-03f0-ed11-8849-002248a2300e" name="3281ed7a-03f0-ed11-8849-002248a2300e" style="margin-top:-8px" type="checkbox" value="true"> En cochant cette case j'accepte de recevoir des informations commerciales de la part de Réseau Astuce </label></div>
</div>
</div>
</div>
...
<div data-editorblocktype="Divider" style="margin: 5px 0px; padding-left: 0px; padding-right: 0px;"><div align="right" class="dividerWrapper" style="padding-top: 5px; padding-bottom: 5px;">
<table role="presentation" style="padding: 0px; margin: 0px; width: 100%;">
	<tbody>
		<tr style="padding: 0px;">
			<td style="margin: 0px; padding: 0px; vertical-align: top; border-bottom: 3px solid rgba(255, 255, 255, 0);">
			<p style="margin: 0px 0px 0px auto; padding: 0px; line-height: 0px; width: 100%;"></p>

			<div class="col-md-offset-3 col-md-5">
			<div class="draggableWrapper">
			<div data-editorblocktype="SubmitButtonBlock">
			<p><button class="lp-form-button lp-form-fieldInput" data-btn-spinner="true" data-loading-text="Envoi en cours" name="submit" type="submit">Envoyer</button></p>
			</div>
			</div>
			</div>
			...
			<div class="draggableWrapper">
			<div class="" data-editorblocktype="Field-lookup" hidden="hidden">
			<div class="marketing-field">
<div class="lp-form-field" data-required-field="true"><label class="lp-ellipsis" for="be32e78a-bbc1-ed11-83ff-002248a2300e" title="">Network1<span class="lp-required" 
style="color: rgb(255, 0, 0);">*</span></label><span title=""><input aria-required="true" class="lp-form-fieldInput" id="be32e78a-bbc1-ed11-83ff-002248a2300e" 
list="list-be32e78a-bbc1-ed11-83ff-002248a2300e" name="be32e78a-bbc1-ed11-83ff-002248a2300e" placeholder="" required="required" style="width: 100%; box-sizing: border-box;" 
type="text" value="ASTUCE"><datalist id="list-be32e78a-bbc1-ed11-83ff-002248a2300e"></datalist></span></div>
</div>
			</div>
			</div>
			</div>
        ...
        ;flex-wrap: wrap;">
			...
			<div class="marketing-field">
			<div class="lp-form-field" data-required-field="true"><label class="lp-ellipsis" for="f837abb4-8250-ed11-bba3-0022489fd42e" title="">Relationship Type<span class="lp-required" 
                style="color: rgb(255, 0, 0);">*</span></label><select aria-required="true" class="lp-form-fieldInput" id="f837abb4-8250-ed11-bba3-0022489fd42e" name="f837abb4-8250-ed11-bba3-0022489fd42e" 
                    required="required" style="width: 100%; box-sizing: border-box;" title=""><option value=""></option><option selected="selected" value="864640000">Customer</option><option value="100000001">
			...
			<div data-editorblocktype="Field-textarea" hidden="hidden" class=""><div class="marketing-field">
<div class="lp-form-field" data-required-field="false"><label class="lp-ellipsis" for="8ca9dd08-81f2-ed11-8849-002248a2300e" title="">FileContent</label><textarea class="lp-form-fieldInput" cols="20" 
    id="8ca9dd08-81f2-ed11-8849-002248a2300e" name="8ca9dd08-81f2-ed11-8849-002248a2300e" rows="5" style="width: 100%; box-sizing: border-box;" title="" value=""></textarea></div>
</div>
</div></div>
			</div>
			</div>
...
<div data-form-block-id="a87b573d-cffb-ed11-8849-0022489fd482"></div> <script src="https://mktdplp102cdn.azureedge.net/public/latest/js/form-loader.js?v=1.84.2007"></script>
<div id="d-nARllS-GbcQoZBJ-7IVA_qQr-JcsbqaoMwEKClGudI"></div><script src="https://mktdplp102cdn.azureedge.net/public/latest/js/ws-tracking.js?v=1.84.2007"></script>
<div class="d365-mkt-config" style="display:none" data-website-id="-nARllS-GbcQoZBJ-7IVA_qQr-JcsbqaoMwEKClGudI" data-hostname="8c2a56b09c9c455b92c18d47fd2020a2.svc.dynamics.com"></div>
